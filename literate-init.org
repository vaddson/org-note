...
- [[#среда][Среда]]
  ...
  - [[#подтверждение-удаления-процессов-при-закрытии-редактора][Подтверждение удаления процессов при закрытии редактора]]
- [[#внешний-вид-ui-и-gui][Внешний вид UI и GUI]]
  ...
  - [[#красивая-статусная-панель-doom-modeline][Красивая статусная панель Doom-modeline]]
...
- [[#редактирование-текста-и-интерфейс-к-нему][Редактирование текста и интерфейс к нему]]
  - [[#cua-mode-совместимость-с-привычными-всем-блокнотами][CUA-mode. Совместимость с привычными всем блокнотами]]
  ...
  - [[#подсветка-отступов][Подсветка отступов]]
...
- [[#работа-с-файлами][Работа с файлами]]
  ...
  - [[#режим-открытых-ранее-файлов][Режим открытых ранее файлов]]
- [[#имитация-интерфейса-блокнотов][Имитация интерфейса блокнотов]]
  - [[#открытие-файлов-автоматически-в-отдельных-вкладках][Открытие файлов автоматически в отдельных вкладках.]]
  - [[#выравнивание-по-правому-краю-статусных-строк][Выравнивание по правому краю статусных строк]]
  - [[#элементы-управления-окнами-в-header-line][Элементы управления окнами в header-line]]
...
- [[#org][Org]]
  ...
  - [[#преобразование-выделенного-региона-в-таблицу][Преобразование выделенного региона в таблицу]]
  - [[#функция-показа-и-скрытия-картинки-в-org-mode][Функция показа и скрытия картинки в org-mode]]
  - [[#разнообразная-реакция-на-ctrl-c-ctrl-c][Разнообразная реакция на Ctrl-C Ctrl-C]]
  - [[#разнообразная-реакция-на-двойное-нажатие-мышки][Разнообразная реакция на двойное нажатие мышки]]
  - [[#изменение-типов-меток-списка][Изменение типов меток списка]]
  ...
  - [[#подгрузка-пакетов-для-запуска-скриптов-в-org-babel-блоках][Подгрузка пакетов для запуска скриптов в org-babel блоках]]
  ...
  - [[#latex-preview-формулы-прямо-в-org-тексте][LaTeX preview. Формулы прямо в org-тексте]]
...
- [[#буфер-на-старте-с-логотипом-dashboard][Буфер на старте с логотипом (dashboard)]]
  - [[#приветственная-страница][Приветственная страница]]
- [[#текст-с-разметкой-или-кодом][Текст с разметкой или кодом]]
...
Для переключения переноса строк используются клавиши =Ctrl-x x t=. Но
добавим и свой вариант =Ctrl-c w=.

#+begin_src emacs-lisp :tangle yes
(global-set-key (kbd "C-c w") #'my/set-word-wrap)
#+end_src
