...
4. Для работы с [[https://www.orgroam.com/][Org-Roam]] (аналог Obsidian) установите Sqlite3.
5. Для работы с проектами установите Ripgrep.
6. Для выполнения src-блоков на языке Python установите его.
7. Аналогично для JavaScript, PHP и Kotlin.
8. Для работы с LaTeX установите все необходимое.
...
(define-key-after global-map [menu-bar org-roam tag]
    (cons "Tag" (make-sparse-keymap "Org-Roam")) 'dailies-capture-today)
(define-key global-map
...
(define-key-after global-map [menu-bar org-roam ref]
    (cons "Ref" (make-sparse-keymap "Org-Roam")) 'dailies-capture-today)
(define-key global-map
...
(define-key-after global-map [menu-bar org-roam alias]
    (cons "Alias" (make-sparse-keymap "Org-Roam")) 'dailies-capture-today)
(define-key global-map
