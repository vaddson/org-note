...
Теперь создадим меню для элементов управления окном.  Их будет три
"X", "□" и муляж "_" для узнаваемости.  Когда разберусь, как их
придвинуть к правому краю, муляж уберу.
