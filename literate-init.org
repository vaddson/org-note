...
1. Для работы с PlantUML установите Java и Graphvis.
2. Для работы с проектами установите Ripgrep.
3. Для выполнения src-блоков на языке Python установите его.
4. Для работы с LaTeX установите все необходимое.
